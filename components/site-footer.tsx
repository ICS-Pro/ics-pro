...
export function SiteFooter() {
  ...
  const pillars = [
    {
      icon: Headset,
      label: t.footer.pillars.professionalSupport,
    },
    {
      icon: ShieldCheck,
      label: t.footer.pillars.trustedSolutions,
    },
    {
      icon: Users,
      label: t.footer.pillars.clientFocused,
    },
  ]
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div className="md:justify-self-end">
            <div className="w-fit">
              <h3
                className={`text-sm font-bold uppercase tracking-wide text-navy-foreground ${
                  language === 'ar' ? 'relative -left-[20px] text-center' : ''
                }`}
              >
              ...
              <div
                dir="ltr"
                className="mt-5 flex flex-col gap-3 text-sm text-navy-foreground/80"
              >
                <a
                  href="https://wa.me/9647890104338"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition-colors hover:text-[#3884ff]"
                >
                  +964 789 010 4338
                </a>
